        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-2">
                    <a href="/prihlasenyAdmin/profilAdmin" class="hlavne">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-4 col-xl-2">
                    <a href="/hlavne/odhlasenie" class="hlavne">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/prihlasenyADmin/uvodPrihlasenyAdmin">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/prihlasenyAdmin/objednavky">Objednávky</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/prihlasenyAdmin/hodnotenia">Hodnotenia</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/prihlasenyAdmin/Zakaznici">Zákazníci</a>
                                </li>
                            </ul>
                        </div>
                    </div>
